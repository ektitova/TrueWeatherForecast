...
class WeatherDataParserTest {
    ...
    /**
     * test get weather forecast from json if parameter is empty
     */
    ...
    /**
     * test get weather forecast from json returns correct data
     */
    @Test
    ...
    /**
     * test get weather forecast throw exception if some parameters in json are missing
     */
