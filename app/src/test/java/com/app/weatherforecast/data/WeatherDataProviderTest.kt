...
class WeatherDataProviderTest {
    ...
    fun getWeatherByDayFromJsonReturnsWeatherForecastWhenJsonStringIsCorrectTest() {
        ...
        verify(exactly = 1) { WeatherDataParser.getWeatherForecastFromJson(eq(forecastJsonString)) }
